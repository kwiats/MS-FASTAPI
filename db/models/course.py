...
class ContentBlock(Timestamp, Base):
    ...
    completed_content_blocks = relationship("CompletedContentBlock", back_populates="conetent_blocks")
...
class StudentCourse(Timestamp, Base):
    ...
    student=relationship(User, back_populates="student_courses") # polacz
